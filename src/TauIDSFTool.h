...
class TauIDSFTool {
  ...
  public:
    ...
    TauIDSFTool() {};
    TauIDSFTool(const std::string& datapath, const std::string& year, const std::string& id="DeepTau2017v2p1VSjet", const std::string& wp="Medium", const std::string& wp_vsele="VVLoose", const bool dm=false, const bool ptdm=true, const bool embedding=false, const bool highpT=false);    
    ~TauIDSFTool() { }
